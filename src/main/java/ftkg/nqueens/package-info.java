/**
 * This module intends to solve the following problem:
 * <p>Place N queens on an NxN chess board so that none of them attack each other (the classic n-queens problem).
